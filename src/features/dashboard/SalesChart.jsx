...
const SalesChart = ({ bookings, numDays }) => {
	...
	return (
		<div className="col-span-full bg-white dark:bg-[#18212f] border border-solid border-gray-100 dark:border-gray-800 p-[3.2rem] flex flex-col gap-10">
			<h2 className="text-[2rem] font-semibold">Sales</h2>
